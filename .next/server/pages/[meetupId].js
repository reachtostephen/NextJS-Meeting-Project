...
/* harmony default export */ var MeetUpDetail = (MeetupDetail);
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://stephen:AIVagU0dwbpMTeqF@cluster0.mq5br.mongodb.net/myFirstDatabase?retryWrites=true&w=majority");
  const db = client.db();
